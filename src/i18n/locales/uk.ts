export default {
  ...
  accounts: {
    ...
    messages: {
      ...
      bulkHidePhoneComplete: 'Приватність номера оновлена: {succeeded} успішно, {failed} невдало',
      bulkTagComplete: 'Тег застосовано до {count} акаунтів',
      selectTagFirst: 'Спочатку оберіть тег',
      noTagsAvailable: 'Тегів ще немає. Спочатку створіть тег.',
    ...
    bulk: {
      ...
      set2FABlockedByProxy: 'Операцію 2FA зупинено: у вибраних акаунтів недоступні проксі.',
      editProfileBlockedByProxy: 'Оновлення профілю зупинено: у вибраних акаунтів недоступні проксі.',
      hidePhone: 'Сховати номер',
      hidePhoneConfirm: 'Сховати номер телефону для {count} обраних акаунтів?',
      hidePhoneBlockedByProxy: 'Операцію зупинено: у вибраних акаунтів недоступні проксі.',
      accountsCount: '{count} акаунтів',
      setTag: 'Встановити тег',
      setTagTitle: 'Масове встановлення тега',
      setTagDescription: 'Додати тег до {count} обраних акаунтів',
      applyTag: 'Застосувати тег',
  ...
  autoComments: {
    ...
    selectAccountsPlaceholder: 'Оберіть акаунти для завдання',
    available: 'доступно',
    libraryTitle: 'Бібліотека коментарів',
    selectTemplates: 'Вибір шаблонів',
    selectTemplatesPlaceholder: 'Оберіть шаблони коментарів',
    searchTemplatesPlaceholder: 'Пошук за назвою, текстом або групою',
    allGroups: 'Всі групи',
    ...
    templateGroup: 'Група',
    templateGroupPlaceholder: 'Наприклад: Веселі, Критика, Підтримка',
    templateContent: 'Текст коментаря',
    templateContentPlaceholder: "---",
    spintaxHint: "---",
    preview: 'Попередній перегляд:',
    importTitle: 'Імпорт з Excel',
    importHint: 'Завантажте `.xlsx`. Формат “один коментар у рядку” підтримується одразу, а назви листів можуть стати групами.',
    importCategoryPlaceholder: 'Група для імпорту (необов’язково)',
    importCategoryHint: 'Якщо залишити порожнім, буде використано назву файлу, листа або колонку групи з таблиці.',
    importDropTitle: 'Перетягніть `.xlsx` сюди',
    importDropHint: 'або натисніть, щоб обрати Excel-файл',
    selectedTemplatesCount: 'Обрано: {count}',
    groupTemplatesCount: '{count} шаблонів',
    selectGroup: 'Обрати групу',
    clearGroup: 'Очистити групу',
    noTemplates: 'Шаблони не створені',
    noTemplatesHint: 'Створіть перший шаблон або завантажте стандартні',
    noTemplatesMatch: 'За поточним фільтром нічого не знайдено',
    noTemplatesMatchHint: 'Змініть групу або пошуковий запит',
    startTask: 'Створити та запустити',
    tasks: 'Завдання',
    tasksCount: '{count} завдань',
    noTasks: 'Немає завдань',
    ...
    messages: {
      ...
      importFailed: 'Не вдалося імпортувати шаблони',
      importSummary: 'Імпортовано: {imported}, дублів пропущено: {duplicates}, невалідних рядків: {invalid}',
      accountsSkipped: '{count} акаунтів пропущено (не валідні)'
    }
  },
  ...
  warming: {
    ...
    maxDelay: 'Макс. затримка',
    minutesShort: 'хв',
    delayHint: 'Випадкова затримка між каналами для одного акаунта: {min}-{max} хвилин. Для дуже молодих акаунтів мінімум може бути автоматично підвищений.',
    estimatePerAccount: 'Приблизно {time} на акаунт, щоб пройти поточний список каналів.',
    accountPickerNoValid: 'У виборі показуються лише валідні акаунти. Перейдіть у список акаунтів і перевірте їх, щоб отримати статус valid.',
    openAccounts: 'Відкрити акаунти',

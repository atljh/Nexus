export default {
  ...
  warming: {
    ...
    maxDelay: 'Max delay',
    minutesShort: 'min',
    delayHint: 'Random delay between channels for one account: {min}-{max} minutes. Very young accounts may still get an automatic higher minimum.',
    estimatePerAccount: 'Approx. {time} per account to finish the current target list.',
    accountPickerNoValid: 'The picker only shows valid accounts. Open the accounts list and verify them first so they get the valid status.',

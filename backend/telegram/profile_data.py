...
MALE_NAMES_UA = [
    ...
    "Гліб", "Захар", "Костянтин", "Віктор", "Григорій", "Микола", "Степан",
    "Федір", "Святослав", "Остап", "Мирослав", "Ростислав", "Євген", "Антон",
    "Артур", "Богуслав", "Орест", "Влас", "Лев", "Данило",
]
...
FEMALE_NAMES_UA = [
    ...
    "Мілана", "Емілія", "Ангеліна", "Кристина", "Маргарита", "Вероніка",
    "Соломія", "Уляна", "Оксана", "Леся", "Христина", "Богдана", "Ярослава",
    "Мирослава", "Орися", "Зоряна", "Олеся", "Любов", "Надія", "Віра",
    "Галина", "Лілія", "Аделіна", "Дарина", "Яна", "Інна", "Лариса",
]
...
MALE_NAMES_RU = [
    ...
    "Владимир", "Павел", "Руслан", "Марк", "Константин", "Тимур", "Олег",
    "Ярослав", "Антон", "Глеб", "Виктор", "Григорий", "Николай", "Степан",
    "Фёдор", "Лев", "Артур", "Вадим", "Виталий", "Богдан", "Захар", "Демьян",
    "Леонид", "Семён", "Юрий", "Святослав",
]

FEMALE_NAMES_RU = [
    "Анастасия", "Мария", "Дарья", "Анна", "Елизавета", "Полина", "Виктория",
    "Екатерина", "Ксения", "София", "Александра", "Валерия", "Алиса", "Арина",
    "Вероника", "Варвара", "Ульяна", "Алёна", "Ольга", "Татьяна", "Наталья",
    "Юлия", "Маргарита", "Кристина", "Диана", "Милана", "Ангелина", "Карина",
    "Елена", "Ирина", "Светлана", "Евгения", "Олеся", "Снежана", "Яна", "Алина",
    "Вера", "Надежда", "Любовь", "Людмила", "Галина", "Оксана", "Лидия", "Нина",
    "Раиса", "Тамара", "Зоя", "Инна",
]
...
# Ukrainian surnames are mostly indeclinable (-енко, -ук, -як), so the same
# forms work for both genders.
LAST_NAMES_UA_MALE = [
    ...
    "Кравчук", "Ковальчук", "Бондарчук", "Сидоренко", "Захарченко", "Левченко",
    "Павленко", "Зінченко", "Дмитренко", "Іваненко", "Гнатюк", "Зайчук",
]
...
LAST_NAMES_RU_MALE = [
    ...
    "Яковлев", "Григорьев", "Романов", "Воробьёв", "Сергеев", "Кузьмин",
    "Фролов", "Александров", "Дмитриев", "Королёв", "Гусев", "Киселёв",
]
...
LAST_NAMES_RU_FEMALE = [
    ...
    "Дмитриева", "Королёва", "Гусева", "Киселёва",
]
...
BIOS_RU = [
    "просто живу", "люблю кофе", "путешественник", "музыка - это жизнь",
    "фотография", "люблю животных", "спорт", "книголюб",
    "природа", "технологии", "киноман", "геймер",
    "путешествия", "люблю котиков", "вкусно поесть", "искусство",
    "живу и наслаждаюсь", "просто я", "позитив", "улыбайся",
    "работаю и отдыхаю", "будь собой",
]
...
def generate_random_profile(gender: Optional[str] = None, locale: str = "en") -> dict:
    ...
    locale: "en" | "ua" | "ru" (anything unknown falls back to "en").
    """
    if gender is None:
    ...
    if locale == "ua":
        ...
        if gender == "male":
            first = random.choice(MALE_NAMES_RU)
            last = random.choice(LAST_NAMES_RU_MALE)
        else:
            first = random.choice(FEMALE_NAMES_RU)
            last = random.choice(LAST_NAMES_RU_FEMALE)
        bio = random.choice(BIOS_RU)
    else:
        if gender == "male":
